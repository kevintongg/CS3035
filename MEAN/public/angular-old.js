...
(function (V, W, v) {
      ...
      "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, m, n, q, p, s, K, w, t, x, L) {
        ...
        function J(a, c, d, e, f, g, k, q, n) {
          ...
          function K(a, e, f, g, n) {
            ...
            ra = n && w;
            P && r(P, function (a) {
              var b = { $scope: a === L || a.$$isolateScope ? Q : e, $element: R, $attrs: x, $transclude: ra }, c;
              C = a.controller;
              "@" == C && (C = x[a.name]);
              c = s(C, b);
              ba[a.name] = c;
        ...
        Nb.prototype = {
          $normalize: qa, $addClass: function (a) {
            ...
            var c = this,
              d = c.$$observers || (c.$$observers = {}), e = d[a] || (d[a] = []);
            e.push(b);
      ...
      "$q", "$injector", function (a, b, c, d, n, q) {
        ...
        function s(c, f, g) {
          ...
          function s() {
            ...
            -1 !== a && p.pendingRequests.splice(a,
              1)
          }
    ...
    this.$get = ["$parse", "$exceptionHandler", "$sce", function (c, d, e) {
      function f(f, l, m) {
        for (var n, q, p = 0, s = [], K = f.length, w = !1,
               t = []; p < K;)-1 != (n = f.indexOf(b, p)) && -1 != (q = f.indexOf(a, n + g)) ? (p != n && s.push(f.substring(p, n)), s.push(p = c(w = f.substring(n + g, q))), p.exp = w, p = q + h, w = !0) : (p != K && s.push(f.substring(p)), p = K);
        (K =
          s.length) || (s.push(""), K = 1);
  ...
  function Ee(b, a) {
    ...
    return {
      defer: e, reject: g, when: function (h, l, m, n) {
      ...
      h.prototype = {
        constructor: h, $new: function (a) {
          ...
          return this.$watch(function () {
            d = l(c);
            var a, b, f;
            if (T(d))if (Ra(d))for (e !== m && (e = m, r = e.length = 0, k++), a = d.length, r !== a && (k++, e.length = r = a), b = 0; b < a; b++)f = e[b] !== e[b] && d[b] !==
              d[b], f || e[b] === d[b] || (k++, e[b] = d[b]); else {
              e !== n && (e = n = {}, r = 0, k++);
              a = 0;
          ...
          var d,
            f, h, l, m = this.$$asyncQueue, r = this.$$postDigestQueue, L, y, v = b, P, N = [], u, Q, C;
          k("$digest");
          g.$$checkUrlChange();
          c = null;
          do {
            ...
            a:do {
              if (l = P.$$watchers)for (L = l.length; L--;)try {
                if (d = l[L])if ((f = d.get(P)) !== (h = d.last) && !(d.eq ? Ba(f, h) : "number" === typeof f && "number" === typeof h && isNaN(f) && isNaN(h))) y = !0, c = d, d.last = d.eq ? Ia(f, null) : f, d.fn(f, h === n ? f : h, P), 5 > v && (u = 4 - v, N[u] || (N[u] = []), Q = O(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) :
                  d.exp, Q += "; newVal: " + oa(f) + "; oldVal: " + oa(h), N[u].push(Q)); else if (d === c) {
                  y = !1;
                  break a
                }
              } catch (D) {
    ...
    this.$get = ["$window", "$document", function (b, a) {
      ...
      return {
        ...
        g), hasEvent: function (a) {
          ...
          return c[a]
        }, csp: Ya(), vendorPrefix: h, transitions: m, animations: n, android: d, msie: u, msieDocumentMode: g
      }
    }]
  }
  ...
  var ie = /([\:\-\_]+(.))/g, je = /^moz([A-Z])/, Gb = z("jqLite"), ke = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Hb = /<|&#?\w+;/,
    le = /<([\w:]+)/, me =
  ...
  var Rc = function (a) {
    ...
    }, ed = Rc(), rd = Rc(!0), We = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
  ...
  var td = ["$animate", function (a) {
    ...
    return {
      restrict: "EA", link: function (e, f, g) {
        var h = g.count, k = g.$attr.when && f.attr(g.$attr.when), l = g.offset || 0, m = e.$eval(k) || {}, n = {},
          q = c.startSymbol(), p = c.endSymbol(), s = /^when(Minus)?(.+)$/;
        r(g, function (a, c) {
    ...
    return {
      transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, f, g, h, k) {
        var l = g.ngRepeat, m = l.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), n, q, p,
          s, u, v, t = { $id: La };
        if (!m)throw d("iexp",
          l);
        g = m[1];
